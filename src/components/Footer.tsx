    ...
    <footer className="bg-foreground text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4 gradient-text">SamScripts</h3>
            <p className="text-white/70 mb-6">
              Transforming ideas into digital excellence with cutting-edge IT solutions.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-white/70 hover:text-white transition-colors">Mobile Development</a></li>
              <li><a href="#" className="text-white/70 hover:text-white transition-colors">DevOps & Cloud</a></li>
          ...
          <div>
            ...
            <address className="not-italic text-white/70">
              ...
              <a href="mailto:info@samscripts.com" className="block mb-2 text-white/70 hover:text-white transition-colors">
                info@samscripts.com
              </a>
        ...
        <div className="border-t border-white/20 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-white/70 text-sm">
            © {currentYear} SamScripts. All rights reserved.
          </p>
          <div className="flex space-x-6 mt-4 md:mt-0">
            ...
            <a href="#" className="text-white/70 hover:text-white text-sm transition-colors">Cookies Policy</a>
          </div>
        </div>
      </div>
    </footer>
